...
import lanyardTextureSrc from "../assets/lanyard/lanyard.png"; // Renamed to avoid conflict with lanyard variable
...
function Band({ maxSpeed = 50, minSpeed = 0 }) {
  ...
  const texture = useTexture(lanyardTextureSrc); // Use renamed import
